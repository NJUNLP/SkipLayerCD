...
MGSM_START_WORDS = {
    'en': ('Question: ', 'Step-by-Step Answer:', 'The answer is %d.'),
    'de': ('Frage: ', 'Schritt-für-Schritt-Antwort:', 'Die Antwort lautet %d.'),
    'fr': ('Question : ', 'Réponse étape par étape :', 'La réponse est %d.'),
    'zh': ('问题：', '逐步解答：', '答案是 %d。'),
    'ja': ('問題：', 'ステップごとの答え：', '答えは%dです。'),
    'es': ('Pregunta: ', 'Respuesta paso a paso:', 'La respuesta es %d.'),
    'ru': ('Задача: ', 'Пошаговое решение:', 'Ответ — %d.'),
    'th': ('โจทย์: ', 'คำตอบทีละขั้นตอน:', 'คำตอบคือ %d'),
    'bn': (
        "\u09aa\u09cd\u09b0\u09b6\u09cd\u09a8: ", 
        "\u09a7\u09be\u09aa\u09c7 \u09a7\u09be\u09aa\u09c7 \u0989\u09a4\u09cd\u09a4\u09b0:",
        "\u0989\u09a4\u09cd\u09a4\u09b0 \u09b9\u09b2 %d\u0964",
    ),
    'sw': ('Swali: ', 'Jibu la Hatua kwa Hatua:', 'Jibu ni %d.'),
    'te': (
        "\u0c2a\u0c4d\u0c30\u0c36\u0c4d\u0c28: ",
        "\u0c26\u0c36\u0c32\u0c35\u0c3e\u0c30\u0c40\u0c17\u0c3e \u0c38\u0c2e\u0c3e\u0c27\u0c3e\u0c28\u0c02:",
        "\u0c38\u0c2e\u0c3e\u0c27\u0c3e\u0c28\u0c02 %d.",
